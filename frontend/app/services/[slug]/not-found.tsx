  ...
  return (
    <div className="min-h-screen bg-[#0b0f19] flex items-center justify-center px-5">
      <div className="text-center max-w-md">
        ...
        {/* Error code */}
        <p className="label-caps mb-3 text-[#3d5a99]">404 — Service Not Found</p>
        ...
        <p className="text-[#8892a4] text-[0.9rem] leading-relaxed mb-8">
          The service you're looking for may have been renamed or removed.
          Browse all our current service offerings below.
        </p>
